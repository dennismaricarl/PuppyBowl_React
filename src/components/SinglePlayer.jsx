   ...
   useEffect(()=> {
    ...
    return (
        ...
        <Card
         ...
         sx={{ width: 500, mb: 5, p: 1}}
        >
         <Typography fontFamily="Georgia" fontWeight="bold" variant='h4'>{singlePup.name}</Typography>
        <CardMedia
            component="img"
        ...
        <Typography sx={{fontFamily: "Georgia", fontSize:20, fontWeight:50, mt: 2}}> {singlePup.breed}</Typography>
        <Typography sx={{fontFamily: "Georgia", fontSize:20, fontWeight:50, mt:1}}>Status: {singlePup.status}</Typography>
        </Card>
        </>
    ) :(
         <p>Loading...</p>
